...
vector2[1]
letters[1:7]
letters[c(1,3,5,7)] #create a vector to look inside another vector at given places
...
#view
head(iris_chr)
#check structure (str) to make sure all columns are character vectors
str(iris_chr)
